...
const SimForm = () => {
  ...
  console.log(setAddActive,setadd_tech_comp)
  return (
    <div className="animate__animated animate__fadeIn">
    <div className="category-title">Sim Form</div>
    <div className="toggle-form-container">
      <DropDownMenu title="Client" />
      <DropDownMenu title="Fleet" />
      <p className="input-box-title">Course Duration</p>
      ...
      <Text title="Category" value="Simulator" disabled={true} />
      <DropDownMenu title="Sub-Category" />
      <DropDownMenu title="Kind" />
      <Text title="Name of the sim training" />
