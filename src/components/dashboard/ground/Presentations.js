...
import { Switch, Text, DropDownMenu, UploadLogo, TableAction, Password } from "../../formitems/Index";
import { LeftOutlined } from "@ant-design/icons";
const Presentations = () => {
  const [search, setsearch] = useState("")
  const [add_new_presentation, setadd_new_presentation] = useState(false)
  ...
  const add_new = () => {
    setadd_new_presentation(true)
  };
  console.log(active_row,setrow_items)

  const closeForm = () => {
    setadd_new_presentation(false)
  };
  return (
    <div className="animate__animated animate__fadeIn">
    <div className={"presentations-container " + (add_new_presentation ? "hide-element" : "")}>
    ...
    <div className={add_new_presentation ? "" : "hide-element"}>
