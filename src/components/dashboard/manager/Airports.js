...
import { Switch, Text, DropDownMenu, TableAction } from "../../formitems/Index";
import { LeftOutlined } from "@ant-design/icons";
const Airports = () => {
  const [search, setsearch] = useState("")
  const [add_new_airport, setadd_new_airport] = useState(false)
  ...
  const add_new = () => {
    setadd_new_airport(true)
    console.log(active_row,setrow_items)
  };

  const closeForm = () => {
    setadd_new_airport(false)
  };
  
  return (
    <div className="animate__animated animate__fadeIn">
    {/* Airport table */}
    <div className={"manager-airport-container " + (add_new_airport ? "hide-element" : "")}>
      <div className="category-title">Airports</div>
      <button className="submit-button" onClick={add_new}>
        Add New Airports
      </button>
      <div className="table-body-container">
        <div className="table-body-header">All Airports</div>
              ...
              return (
                <div className="table-row-container" key={index}>
                  <div className="table-row-top">
                    <div className="items">
                      <div className="title">ICAO</div>
                      <div className="value">{data.client}</div>
                    </div>
                    <div className="items">
                      <div className="title">IATA</div>
    ...
    <div className={add_new_airport ? "" : "hide-element"}>
      <div className="category-title">
        <span className="client-back" onClick={() => closeForm()}>
          {<LeftOutlined />} Airport
        </span>
        Add New Airport
      </div>
