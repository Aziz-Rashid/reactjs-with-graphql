...
const StudyMaterials = () => {
  ...
  const [add_new_material, setadd_new_material] = useState(false)
  ...
  const add_new = () => {
    setadd_new_material(true)
  };

  const closeForm = () => {
    setadd_new_material(false)
  };
  return (
    <div className="animate__animated animate__fadeIn">
        {/* Study material table */}
        <div className={"study-materials-container " + (add_new_material ? "hide-element" : "")}>
        ...
        <div className={add_new_material ? "" : "hide-element"}>
